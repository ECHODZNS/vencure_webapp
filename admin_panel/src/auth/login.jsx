...
export default class Login extends PureComponent {
  ...
  onSubmit = async (event) => {
    ...
    Axios.post(server + "/api/auth/adminLogin", params, this.state.config)
      .then((rsp) => {
        this.setState({
          loader: "",
          message: <Alert className="success" message={rsp.data.detail} />,
        });
        localStorage.setItem("adminToken", rsp.data.payload.token);
                ...
                <div className="nk-block-head">
                  <div className="nk-block-head-content">
                    ...
                    <div className="nk-block-des">
                      <p>
                        Access the VenCure admin panel using email and password.
                      </p>
                    </div>
                  </div>
                </div>
